...
static char *ngx_rtmp_hls_merge_app_conf(ngx_conf_t *cf, void *parent,
                                         void *child);
...
static ngx_command_t ngx_rtmp_hls_commands[] = {
    ...
    {ngx_string("hls"),
     ...
     offsetof(ngx_rtmp_hls_app_conf_t, hls), NULL},

    {ngx_string("hls_fragment"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, fraglen), NULL},

    {ngx_string("hls_max_fragment"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, max_fraglen), NULL},

    {ngx_string("hls_path"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, path), NULL},

    {ngx_string("hls_playlist_length"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, playlen), NULL},

    {ngx_string("hls_muxdelay"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, muxdelay), NULL},

    {ngx_string("hls_sync"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, sync), NULL},

    {ngx_string("hls_continuous"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, continuous), NULL},

    {ngx_string("hls_nested"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, nested), NULL},

    {ngx_string("hls_fragment_naming"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_enum_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, naming), &ngx_rtmp_hls_naming_slots},

    {ngx_string("hls_fragment_slicing"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_enum_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, slicing), &ngx_rtmp_hls_slicing_slots},

    {ngx_string("hls_type"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_enum_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, type), &ngx_rtmp_hls_type_slots},

    {ngx_string("hls_max_audio_delay"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, max_audio_delay), NULL},

    {ngx_string("hls_audio_buffer_size"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, audio_buffer_size), NULL},

    {ngx_string("hls_cleanup"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, cleanup), NULL},

    {ngx_string("hls_variant"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_1MORE,
     ngx_rtmp_hls_variant, NGX_RTMP_APP_CONF_OFFSET, 0, NULL},

    {ngx_string("hls_base_url"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, base_url), NULL},

    {ngx_string("hls_fragment_naming_granularity"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, granularity), NULL},

    {ngx_string("hls_deny_name"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, deny_name), NULL},
...
static ngx_rtmp_hls_frag_t *ngx_rtmp_hls_get_frag(ngx_rtmp_session_t *s,
                                                  ngx_int_t n) {
...
static void ngx_rtmp_hls_next_frag(ngx_rtmp_session_t *s) {
  ngx_rtmp_hls_ctx_t *ctx;
  ngx_rtmp_hls_app_conf_t *hacf;
...
static ngx_int_t ngx_rtmp_hls_rename_file(u_char *src, u_char *dst) {
...
static ngx_int_t ngx_rtmp_hls_write_variant_playlist(ngx_rtmp_session_t *s) {
...
#define NGX_RTMP_HLS_VAR_HEADER "#EXTM3U\n#EXT-X-VERSION:3\n"
  ...
  for (n = 0; n < hacf->variant->nelts; n++, var++) {
    ...
    p = ngx_slprintf(p, last, "%V%*s%V", &hacf->base_url,
  ...
  if (ngx_rtmp_hls_rename_file(ctx->var_playlist_bak.data,
    ...
    ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                  "hls: rename failed: '%V'->'%V'", &ctx->var_playlist_bak,
                  &ctx->var_playlist);
    return NGX_ERROR;
  }
...
static ngx_int_t ngx_rtmp_hls_write_playlist(ngx_rtmp_session_t *s) {
  static u_char buffer[1024];
  ngx_fd_t fd;
  u_char *p;
  ngx_rtmp_hls_ctx_t *ctx;
  ...
  fd = ngx_open_file(ctx->playlist_bak.data, NGX_FILE_WRONLY, NGX_FILE_TRUNCATE,
                     NGX_FILE_DEFAULT_ACCESS);

  if (fd == NGX_INVALID_FILE) {
    ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                  "hls: " ngx_open_file_n " failed: '%V'", &ctx->playlist_bak);
    return NGX_ERROR;
  }
  ...
  if (n < 0) {
    ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                  "hls: " ngx_write_fd_n " failed: '%V'", &ctx->playlist_bak);
    ngx_close_file(fd);
    return NGX_ERROR;
  }
  ...
  if (ngx_rtmp_hls_rename_file(ctx->playlist_bak.data, ctx->playlist.data) ==
      NGX_FILE_ERROR) {
    ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                  "hls: rename failed: '%V'->'%V'", &ctx->playlist_bak,
                  &ctx->playlist);
    return NGX_ERROR;
  }
...
ngx_int_t ngx_rtmp_hls_copy(ngx_rtmp_session_t *s, void *dst,
                                   u_char **src, size_t n, ngx_chain_t **in) {
  u_char *last;
  size_t pn;
...
static ngx_int_t ngx_rtmp_hls_append_aud(ngx_rtmp_session_t *s,
                                         ngx_buf_t *out) {
...
static ngx_int_t ngx_rtmp_hls_append_sps_pps(ngx_rtmp_session_t *s,
                                             ngx_buf_t *out) {
...
static uint64_t ngx_rtmp_hls_get_fragment_id(ngx_rtmp_session_t *s,
                                             uint64_t ts) {
  ngx_rtmp_hls_ctx_t *ctx;
  ngx_rtmp_hls_app_conf_t *hacf;
...
static ngx_int_t ngx_rtmp_hls_close_fragment(ngx_rtmp_session_t *s) {
  ngx_rtmp_hls_ctx_t *ctx;
...
static ngx_int_t ngx_rtmp_hls_open_fragment(ngx_rtmp_session_t *s, uint64_t ts,
                                            ngx_int_t discont) {
  uint64_t id;
  ngx_uint_t g;
  ngx_rtmp_hls_ctx_t *ctx;
...
static void ngx_rtmp_hls_restore_stream(ngx_rtmp_session_t *s) {
  ngx_rtmp_hls_ctx_t *ctx;
  ngx_file_t file;
  ssize_t ret;
  off_t offset;
  ...
  file.fd =
      ngx_open_file(ctx->playlist.data, NGX_FILE_RDONLY, NGX_FILE_OPEN, 0);
  ...
  *ngx_snprintf(path, sizeof(path) - 1, "%V", &hacf->path) = 0;
  ...
  if (ngx_file_info(path, &fi) == NGX_FILE_ERROR) {
    if (ngx_errno != NGX_ENOENT) {
      ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                    "hls: " ngx_file_info_n " failed on '%V'", &hacf->path);
      return NGX_ERROR;
    }
    ...
    if (ngx_create_dir(path, NGX_RTMP_HLS_DIR_ACCESS) == NGX_FILE_ERROR) {
      ngx_log_error(NGX_LOG_ERR, s->connection->log, ngx_errno,
                    "hls: " ngx_create_dir_n " failed on '%V'", &hacf->path);
      return NGX_ERROR;
    }
    ...
    if (!ngx_is_dir(&fi)) {
      ngx_log_error(NGX_LOG_ERR, s->connection->log, 0,
                    "hls: '%V' exists and is not a directory", &hacf->path);
      return NGX_ERROR;
    }
...
static ngx_int_t ngx_rtmp_hls_publish(ngx_rtmp_session_t *s,
  ...
  ctx->is_hls =
      (*(hacf->deny_name.data) != '\0' &&
       ngx_rtmp_is_match_len((const char *)hacf->deny_name.data, hacf->deny_name.len,
                   (const char *)s->stream_name, ngx_strlen(s->stream_name)) == 1)
          ? 0
          : 1;
  ...
  if (ctx->frags == NULL) {
    ctx->frags = ngx_pcalloc(s->connection->pool, sizeof(ngx_rtmp_hls_frag_t) *
                                                      (hacf->winfrags * 2 + 1));
    if (ctx->frags == NULL) {
      return NGX_ERROR;
    }
  ...
  *ngx_cpymem(ctx->name.data, v->name, ctx->name.len) = 0;
  ...
  ctx->stream.data = ngx_palloc(
      s->connection->pool, ctx->stream.len + NGX_INT64_LEN + sizeof(".ts"));
    ...
    for (n = 0; n < hacf->variant->nelts; n++, var++) {
      if (ctx->name.len > var->suffix.len &&
        ...
        ctx->var_playlist.data =
            ngx_palloc(s->connection->pool, ctx->var_playlist.len + 1);
        ...
        *pp = 0;
        ...
        ctx->var_playlist_bak.len = ctx->var_playlist.len + sizeof(".bak") - 1;
        ctx->var_playlist_bak.data =
            ngx_palloc(s->connection->pool, ctx->var_playlist_bak.len + 1);

        pp = ngx_cpymem(ctx->var_playlist_bak.data, ctx->var_playlist.data,
  ...
  *p = 0;
  ...
  p = ngx_cpymem(ctx->playlist_bak.data, ctx->playlist.data, ctx->playlist.len);
...
static ngx_int_t ngx_rtmp_hls_close_stream(ngx_rtmp_session_t *s,
  ...
  if (hacf == NULL || !hacf->hls || ctx == NULL || !ctx->is_hls) {
    goto next;
  }
...
static ngx_int_t ngx_rtmp_hls_parse_aac_header(ngx_rtmp_session_t *s,
                                               ngx_uint_t *objtype,
                                               ngx_uint_t *srindex,
                                               ngx_uint_t *chconf) {
  ngx_rtmp_codec_ctx_t *codec_ctx;
...
static void ngx_rtmp_hls_update_fragment(ngx_rtmp_session_t *s, uint64_t ts,
                                         ngx_int_t boundary,
...
static ngx_int_t ngx_rtmp_hls_audio(ngx_rtmp_session_t *s, ngx_rtmp_header_t *h,
                                    ngx_chain_t *in) {
  ngx_rtmp_hls_app_conf_t *hacf;
  ngx_rtmp_hls_ctx_t *ctx;
  ngx_rtmp_codec_ctx_t *codec_ctx;
  ...
  if (ngx_rtmp_hls_parse_aac_header(s, &objtype, &srindex, &chconf) != NGX_OK) {
    ngx_log_error(NGX_LOG_ERR, s->connection->log, 0, "hls: aac header error");
    return NGX_OK;
  }
  ...
  p[1] = 0xf1;
  p[2] =
      (u_char)(((objtype - 1) << 6) | (srindex << 2) | ((chconf & 0x04) >> 2));
  ...
  est_pts = ctx->aframe_base +
            ctx->aframe_num * 90000 * 1024 / codec_ctx->sample_rate;
  dpts = (int64_t)(est_pts - pts);

  ngx_log_debug2(NGX_LOG_DEBUG_RTMP, s->connection->log, 0,
                 "hls: audio sync dpts=%L (%.5fs)", dpts, dpts / 90000.);
  ...
  ngx_log_debug2(NGX_LOG_DEBUG_RTMP, s->connection->log, 0,
                 "hls: audio sync gap dpts=%L (%.5fs)", dpts, dpts / 90000.);

  return NGX_OK;
}

static ngx_int_t ngx_rtmp_hls_video(ngx_rtmp_session_t *s, ngx_rtmp_header_t *h,
                                    ngx_chain_t *in) {
  ngx_rtmp_hls_app_conf_t *hacf;
  ngx_rtmp_hls_ctx_t *ctx;
  ngx_rtmp_codec_ctx_t *codec_ctx;
  ...
  if (hacf == NULL || !hacf->hls || ctx == NULL || codec_ctx == NULL ||
      !ctx->is_hls || codec_ctx->avc_header == NULL || h->mlen < 1) {
    return NGX_OK;
  }
  ...
  while (in) {
    ...
    ngx_log_debug2(NGX_LOG_DEBUG_RTMP, s->connection->log, 0,
                   "hls: h264 NAL type=%ui, len=%uD", (ngx_uint_t)nal_type,
                   len);
...
static ngx_int_t ngx_rtmp_hls_stream_begin(ngx_rtmp_session_t *s,
                                           ngx_rtmp_stream_begin_t *v) {
  return next_stream_begin(s, v);
}

static ngx_int_t ngx_rtmp_hls_stream_eof(ngx_rtmp_session_t *s,
...
static ngx_int_t ngx_rtmp_hls_cleanup_dir(ngx_str_t *ppath,
                                          ngx_msec_t playlen) {
  ngx_dir_t dir;
  ...
  ngx_log_debug2(NGX_LOG_DEBUG_RTMP, ngx_cycle->log, 0,
                 "hls: cleanup path='%V' playlen=%M", ppath, playlen);
  ...
  for (;;) {
    ...
    if (ngx_read_dir(&dir) == NGX_ERROR) {
      ...
      if (ngx_close_dir(&dir) == NGX_ERROR) {
        ngx_log_error(NGX_LOG_CRIT, ngx_cycle->log, ngx_errno,
                      "hls: cleanup " ngx_close_dir_n " \"%V\" failed", ppath);
      }
      ...
      ngx_log_error(NGX_LOG_CRIT, ngx_cycle->log, err,
                    "hls: cleanup " ngx_read_dir_n " '%V' failed", ppath);
      return NGX_ERROR;
    }
    ...
    *p = 0;
    ...
    if (!dir.valid_info && ngx_de_info(path, &dir) == NGX_FILE_ERROR) {
      ngx_log_error(NGX_LOG_CRIT, ngx_cycle->log, ngx_errno,
                    "hls: cleanup " ngx_de_info_n " \"%V\" failed", &spath);
        ...
        *p = 0;
        ...
        if (ngx_delete_dir(path) == NGX_FILE_ERROR) {
          ngx_log_error(NGX_LOG_ERR, ngx_cycle->log, ngx_errno,
                        "hls: cleanup " ngx_delete_dir_n " failed on '%V'",
                        &spath);
        } else {
          nerased++;
        }
    ...
    if (name.len >= 3 && name.data[name.len - 3] == '.' &&
        name.data[name.len - 2] == 't' && name.data[name.len - 1] == 's') {
      max_age = playlen / 500;
    ...
    ngx_log_debug3(NGX_LOG_DEBUG_RTMP, ngx_cycle->log, 0,
                   "hls: cleanup '%V' mtime=%T age=%T", &name, mtime,
...
static time_t ngx_rtmp_hls_cleanup(void *data) {
...
static char *ngx_rtmp_hls_variant(ngx_conf_t *cf, ngx_command_t *cmd,
  ...
  if (hacf->variant == NULL) {
    hacf->variant =
        ngx_array_create(cf->pool, 1, sizeof(ngx_rtmp_hls_variant_t));
    if (hacf->variant == NULL) {
...
static char *ngx_rtmp_hls_merge_app_conf(ngx_conf_t *cf, void *parent,
  ...
  ngx_conf_merge_str_value(conf->deny_name, prev->deny_name, "");
