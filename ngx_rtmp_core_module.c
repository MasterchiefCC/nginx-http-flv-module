...
static ngx_conf_post_t ngx_rtmp_core_lowat_post = {ngx_rtmp_core_lowat_check};
...
static ngx_command_t ngx_rtmp_core_commands[] = {
    ...
    {ngx_string("server"),
     ...
     ngx_rtmp_core_server, 0, 0, NULL},

    {ngx_string("listen"), NGX_RTMP_SRV_CONF | NGX_CONF_1MORE,
     ngx_rtmp_core_listen, NGX_RTMP_SRV_CONF_OFFSET, 0, NULL},

    {ngx_string("server_name"), NGX_RTMP_SRV_CONF | NGX_CONF_1MORE,
     ngx_rtmp_core_server_name, NGX_RTMP_SRV_CONF_OFFSET, 0, NULL},

    {ngx_string("application"),
     NGX_RTMP_SRV_CONF | NGX_CONF_BLOCK | NGX_CONF_TAKE1,
     ngx_rtmp_core_application, NGX_RTMP_SRV_CONF_OFFSET, 0, NULL},

    {ngx_string("so_keepalive"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_RTMP_SRV_CONF_OFFSET,
    ...
    {ngx_string("timeout"),
     ...
     offsetof(ngx_rtmp_core_srv_conf_t, timeout), NULL},

    {ngx_string("ping"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, ping), NULL},

    {ngx_string("ping_timeout"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, ping_timeout), NULL},

    {ngx_string("max_streams"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, max_streams), NULL},

    {ngx_string("ack_window"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, ack_window), NULL},

    {ngx_string("chunk_size"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_num_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, chunk_size), NULL},

    {ngx_string("max_message"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, max_message), NULL},

    {ngx_string("out_queue"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, out_queue), NULL},

    {ngx_string("out_cork"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, out_cork), NULL},

    {ngx_string("busy"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, busy), NULL},
    ...
    {ngx_string("play_time_fix"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, play_time_fix), NULL},

    {ngx_string("publish_time_fix"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, publish_time_fix), NULL},

    {ngx_string("buflen"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, buflen), NULL},

    {ngx_string("tcp_nopush"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, tcp_nopush), NULL},

    {ngx_string("tcp_nodelay"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, tcp_nodelay), NULL},

    {ngx_string("send_timeout"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, send_timeout), NULL},

    {ngx_string("send_lowat"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, send_lowat), &ngx_rtmp_core_lowat_post},

    {ngx_string("postpone_output"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, postpone_output), NULL},
    ...
    {ngx_string("limit_rate"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
         ...
         | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, limit_rate), NULL},
    ...
    {ngx_string("limit_rate_after"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
         ...
         | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, limit_rate_after), NULL},

    {ngx_string("keepalive_timeout"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE12,
     ngx_rtmp_core_keepalive, NGX_RTMP_APP_CONF_OFFSET, 0, NULL},

    {ngx_string("lingering_time"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, lingering_time), NULL},

    {ngx_string("lingering_timeout"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, lingering_timeout), NULL},

    {ngx_string("resolver"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_1MORE,
     ngx_rtmp_core_resolver, NGX_RTMP_APP_CONF_OFFSET, 0, NULL},

    {ngx_string("resolver_timeout"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_RTMP_APP_CONF |
         NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_core_app_conf_t, resolver_timeout), NULL},
    ...
    {ngx_string("merge_slashes"),
     NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_RTMP_SRV_CONF_OFFSET,
     offsetof(ngx_rtmp_core_srv_conf_t, merge_slashes), NULL},
...
static void *ngx_rtmp_core_create_main_conf(ngx_conf_t *cf) {
  ...
  if (ngx_array_init(&cmcf->servers, cf->pool, 4,
                     sizeof(ngx_rtmp_core_srv_conf_t *)) != NGX_OK) {
    return NULL;
  }
...
static void *ngx_rtmp_core_create_srv_conf(ngx_conf_t *cf) {
  ...
  if (ngx_array_init(&conf->server_names, cf->temp_pool, 4,
                     sizeof(ngx_rtmp_server_name_t)) != NGX_OK) {
    return NULL;
  }

  if (ngx_array_init(&conf->applications, cf->pool, 4,
                     sizeof(ngx_rtmp_core_app_conf_t *)) != NGX_OK) {
    return NULL;
  }
...
static ngx_int_t ngx_rtmp_add_listen(ngx_conf_t *cf,
  ...
  if (cmcf->ports == NULL) {
    cmcf->ports =
        ngx_array_create(cf->temp_pool, 2, sizeof(ngx_rtmp_conf_port_t));
    if (cmcf->ports == NULL) {
      return NGX_ERROR;
    }
  }
...
static ngx_int_t ngx_rtmp_add_addresses(ngx_conf_t *cf,
  ...
  for (i = 0; i < port->addrs.nelts; i++) {
    ...
    if (ngx_cmp_sockaddr(&lsopt->sockaddr.sockaddr, lsopt->socklen,
                         &addr[i].opt.sockaddr.sockaddr, addr[i].opt.socklen,
                         0) != NGX_OK)
#endif
    {
      continue;
...
static ngx_int_t ngx_rtmp_add_server(ngx_conf_t *cf,
  ...
  if (addr->servers.elts == NULL) {
    ...
    for (i = 0; i < addr->servers.nelts; i++) {
      if (server[i] == cscf) {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "a duplicate listen %s",
                           addr->opt.addr);
        return NGX_ERROR;
      }
    }
...
static char *ngx_rtmp_core_application(ngx_conf_t *cf, ngx_command_t *cmd,
  ...
  for (n = 0; n < cscf->applications.nelts; n++) {
    if (cacf->name.len == cacfp[n]->name.len &&
        ngx_strncmp(cacf->name.data, cacfp[n]->name.data, cacf->name.len) ==
            0) {
      ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "duplicate application: \"%V\"",
                         &cacf->name);
